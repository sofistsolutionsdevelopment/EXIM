...
class DirectScan_BoxRouteDetailsPage extends StatefulWidget {
  ...
  DirectScan_BoxRouteDetailsPage({this.onPressed, this.boxNo_Value, this.boxNo, this.invoiceNo, this.custShortCode});

  @override
  _DirectScan_BoxRouteDetailsPageState createState() => _DirectScan_BoxRouteDetailsPageState();
}

class _DirectScan_BoxRouteDetailsPageState extends State<DirectScan_BoxRouteDetailsPage> {
  ...
  Future<GetBoxRouteDetailsDataModel> getBoxRouteDetails () async{
    ...
    try{
      ...
      print("Api getBoxRouteDetails  widget.boxNo_Value : ${ widget.boxNo_Value}");
      ...
      if(response.statusCode == 200){
        ...
        setState(() {
          ...
          _resultGetBoxRouteDetailsResult = RouteJson["Data"].map<GetBoxRouteDetailsResultModel>((e) => GetBoxRouteDetailsResultModel.fromJson(e)).toList();
        });
  ...
  Future<SaveDataModel> save (String routeCode, String boxNo_value, String stepCode, String inputValue, String inputDDLValue, String compCode) async {
    try {
      final _prefs = await SharedPreferences.getInstance();
      String _API_Path = _prefs.getString('API_Path');
      String _Token = _prefs.getString('Token');
  ...
  Future<void> _qrScanSuccess(BuildContext context, String routeCode, String boxNo_value, String stepCode, String inputDDLValue, String compCode) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            title: Text('Enter AWB Number Below', style:  TextStyle(fontFamily: "AlternateGothic",
              fontWeight: FontWeight.w500, fontSize: 26, letterSpacing:1 , color: appColor),),
            content: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(fontFamily: "AlternateGothic",
                    fontWeight: FontWeight.w500, fontSize: 26, letterSpacing: 2),
              ),
              style: TextStyle(fontFamily: "AlternateGothic",
                  fontWeight: FontWeight.w500, fontSize: 26, letterSpacing: 2 , color: appColor),
                ...
                onPressed: () async{
                  if(_controllerInputValue.text == ""){
                    ...
                    setState(() {
                      ...
                      print("_controllerInputValue : ${_controllerInputValue.text}");
                      ...
                      debugPrint('_qrScanSuccess inputDDLValue : $inputDDLValue');
                      debugPrint('_qrScanSuccess compCode : $compCode');

                    });

                    final SaveDataModel saveresult = await save(routeCode, boxNo_value, stepCode, _inputValue, inputDDLValue, compCode);
                    debugPrint('2');
                    ...
                    if (saveresult == null) {
                      ...
                      if(statusCode == "500"){
                        if (_saveResult.ExceptionMessage != "") {
                          debugPrint('statusCode : 500 *** ${_saveResult.ExceptionMessage}');
  ...
  Future<GetDDLFailureReasonsDataModel> getDDL () async{
    ...
    try{
      ...
      if(response.statusCode == 200){
        ...
        debugPrint('Api getDDL 6 getDDLFailureReasonsJson ${getDDLFailureReasonsJson}');
        ...
        setState(() {
          ...
          _resultGetDDLFailureReasonsResult = getDDLFailureReasonsJson["Data"].map<GetDDLFailureReasonsResultModel>((e) => GetDDLFailureReasonsResultModel.fromJson(e)).toList();
        });
  ...
  Future<bool> AlertToSave(String routeCode, String boxNo_value, String stepCode, String inputValue, String inputDDLValue, String compCode) {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('Do you want to save?', style: TextStyle(fontFamily: "Poppins",
                      ...
                      if (getBoxRouteDetailsListLenght == 0)
                        Center(
                          child: Text(
                            ...
                            style: TextStyle(fontSize: 20,color: appColor,fontFamily: "Poppins",
                              fontWeight: FontWeight.w500,),
                          ),
                        ),
                      if (getBoxRouteDetailsListLenght != 0)
                              ...
                              children: <Widget>[
                                SizedBox(
                                  ...
                                  child: Container(
                                    color: Colors.white,
                                    child: Padding(
                                      padding: const EdgeInsets.only(top:18, bottom:18, right: 5, left: 5),
                                      child: Text("Box No ", style: TextStyle(fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,fontSize: 22, letterSpacing: 1),textAlign: TextAlign.center,),
                                    ),
                                  ),
                                ),
                                ...
                                Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.only(top:18, bottom:18, right: 5, left: 20),
                                      child: Text("${widget.boxNo}",style: TextStyle(fontFamily: "Poppins",
                                        fontWeight: FontWeight.w500,fontSize: 22, letterSpacing: 1, color: appColor),textAlign: TextAlign.left,),
                                    )),
                                ...
                                if (snapshot.hasData)
                                {
                                  return  Center(
                                    child: ListView.builder(
                                      itemCount: getBoxRouteDetailsDataList.length,
                                      itemBuilder: (context, index) {

                                        IsScanRequired = getBoxRouteDetailsDataList[index]["IsScanRequired"];
                                        ...
                                        return
                                          Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Confirm" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == false) //// This is for Confirm FALSE
                                              Padding(
                                                  ...
                                                  InkWell(
                                                    onTap: () async{
                                                      ...
                                                      var connectivityResult = await (Connectivity().checkConnectivity());
                                                      if (connectivityResult == ConnectivityResult.none) {
                                                        print("*** _isConnected Box Route Details = $connectivityResult ****");
                                                        Navigator.push(context, SlideLeftRoute(page: NoInternetPage()));
                                                      }
                                                      else if (connectivityResult == ConnectivityResult.wifi || connectivityResult == ConnectivityResult.mobile) {
                                                        print("*** _isConnected Box Route Details = $connectivityResult ****");
                                                    ...
                                                    child: Card(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          ListTile(
                                                            ...
                                                            trailing:  Row(
                                                              ...
                                                              children: <Widget>[
                                                                ...
                                                                SizedBox(width: 5,),
                                                                Image.asset(
                                                                  "assets/-0.png",width: 40,height: 40,
                                                                ),
                                                              ],
                                                            ),
                                                          ...
                                                          if(getBoxRouteDetailsDataList[index]["ProcessingTime"] != null)
                                                            SizedBox(height: 5,),
                                                          if(getBoxRouteDetailsDataList[index]["ProcessingTime"] != null)
                                                            Container(
                                                                width: MediaQuery.of(context).size.width,
                                                                ...
                                                                child: Padding(
                                                                  padding: const EdgeInsets.all(5),
                                                                  child: Center(
                                                                    child: Text("Processing Timing ${getBoxRouteDetailsDataList[index]["ProcessingTime"].toString()} mins", style:TextStyle(fontSize: 13, fontFamily: "Poppins",
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Confirm" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == true) //// This is for Confirm TRUE
                                              Padding(
                                                padding: const EdgeInsets.only(top:5.0),
                                                child:
                                                Card(
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Logical" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == false)  //// This is for Logical
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  Container(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Slidable(
                                                            ...
                                                            child: Container(
                                                              color: Colors.white,
                                                              child: ListTile(
                                                                leading:  Icon(Icons.navigate_before,size: 25,color: Colors.black54,),
                                                                title:  Text(//"cjnjvnjhcvjhxjhvhbdsjhvb",
                                                                  getBoxRouteDetailsDataList[index]["StepCaption"],
                                                                  style:TextStyle(fontSize: 16,  fontFamily: "Poppins",
                                                                      fontWeight: FontWeight.w500,color: appColor),),
                                                                ...
                                                                trailing: Icon(Icons.navigate_next,size: 25,color: Colors.black54,),
                                                              ),
                                                            ),
                                                            actions: <Widget>[
                                                              InkWell(
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Logical"  && getBoxRouteDetailsDataList[index]["IsStepComplete"] == true && getBoxRouteDetailsDataList[index]["InputValue"] == "Yes")  //// This is to show Enter Logical Data is YES
                                              Padding(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              ...
                                                              Container(
                                                                  ...
                                                                  color: routePageColor,
                                                                  child: Padding(
                                                                    padding: const EdgeInsets.only(top:15, bottom:15, right: 5, left: 20),
                                                                    child:
                                                                    Column(
                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                      mainAxisAlignment: MainAxisAlignment.start,
                                                                      children: <Widget>[
                                                                        Text(getBoxRouteDetailsDataList[index]["StepCaption"],style: TextStyle(fontFamily: "Poppins",
                                                                            fontWeight: FontWeight.w500,fontSize: 20, letterSpacing: 1, color: appColor),textAlign: TextAlign.start,),
                                                                        SizedBox(height: 8),
                                                                        Text(//"21-2-2022",
                                                                          getBoxRouteDetailsDataList[index]["RouteDate"],
                                                                          style:TextStyle(fontSize: 16, fontFamily: "Poppins",
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Logical"  && getBoxRouteDetailsDataList[index]["IsStepComplete"] == true && getBoxRouteDetailsDataList[index]["InputValue"] == "No") //// This is to show Enter Logical Data is NO
                                              Padding(
                                                  padding: const EdgeInsets.only(top:7),
                                                  child:
                                                  Container(
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Input Text" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == false)  //// This is for Input
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  InkWell(
                                                            ...
                                                            if (validateQRresult == null) {
                                                              ...
                                                              if(statusCode == "200"){
                                                                ...
                                                                if(Validate == "1"){
                                                                  ...
                                                                  _qrScanSuccess(context, routeCode, boxNo_value, stepCode, inputDDLValue, compCode);
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(//"cjnjvnjhcvjhxjhvhbdsjhvb",
                                                                getBoxRouteDetailsDataList[index]["StepCaption"],
                                                                style:TextStyle(fontSize: 16,  fontFamily: "Poppins",
                                                                    fontWeight: FontWeight.w500,color: appColor),),
                                                            ),
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Input Text" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == true)  //// This is to show Enter Input Data
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Padding(
                                                            padding: const EdgeInsets.only(top:15, bottom: 15, right: 10, left: 10),
                                                            child:   Text(//"cjnjvnjhcvjhxjhvhbdsjhvb",
                                                              getBoxRouteDetailsDataList[index]["InputValue"],
                                                              style:TextStyle(fontSize: 16,  fontFamily: "Poppins",
                                                                  fontWeight: FontWeight.w500,color: appColor),textAlign: TextAlign.center,),
                                                          ),
                                                        ],
                                                      ),
                                                    ),
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "End")  //// This is for END
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  Container(
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Input DDL" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == false)  //// This is for Drowpdown false
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  InkWell(
                                                            ...
                                                            if (validateQRresult == null) {
                                                              ...
                                                              if(statusCode == "200"){
                                                                ...
                                                                if(Validate == "1"){
                                                                  ...
                                                                  String routeCode = getBoxRouteDetailsDataList[index]["RouteCode"].toString();
                                                                  String boxNo_value = widget.boxNo_Value;
                                                                  String stepCode = getBoxRouteDetailsDataList[index]["StepCode"].toString();
                                                                  String inputValue = "";
                                                                  String compCode = getBoxRouteDetailsDataList[index]["CompCode"].toString();
                                                                  ...
                                                                  showConfirmationDialog(context, routeCode, boxNo_value, stepCode, inputValue, compCode);
                                                                }
                                                                if(Validate == "0"){
                                                                  debugPrint('**');
                                                                  _displaySnackBar(context);
                                              ...
                                              if(getBoxRouteDetailsDataList[index]["Action"] == "Input DDL" && getBoxRouteDetailsDataList[index]["IsStepComplete"] == true)  //// This is for Drowpdown  true
                                              Padding(
                                                  padding: const EdgeInsets.only(top:5.0),
                                                  child:
                                                  Container(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: <Widget>[
                                                          ...
                                                          Padding(
                                                            padding: const EdgeInsets.only(top:15, bottom: 15, right: 10, left: 10),
                                                            child:Text(//"cjnjvnjhcvjhxjhvhbdsjhvb",
                                                              getBoxRouteDetailsDataList[index]["InputDDLValue"],
                                                              style:TextStyle(fontSize: 16,  fontFamily: "Poppins",
                                                                  fontWeight: FontWeight.w500,color: appColor),textAlign: TextAlign.center,),
                                                          ),
                                                        ],
  ...
  showConfirmationDialog(BuildContext context, String routeCode, String boxNo_value, String stepCode, String inputValue, String compCode) {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) {
        return CustomDialog(routeCode:routeCode, boxNo_value:boxNo_value, stepCode:stepCode, inputValue:inputValue, compCode:compCode, boxNo_Value:widget.boxNo_Value, boxNo:widget.boxNo);
      },
    );
  }
}
...
class CustomDialog extends StatefulWidget {
  ...
  CustomDialog({this.routeCode, this.boxNo_value, this.stepCode, this.inputValue, this.compCode, this.onPressed, this.exportType_value, this.exportType, this.boxNo_Value, this.boxNo, this.boxCount});
...
class _CustomDialogState extends State<CustomDialog> {
  ...
  Future<GetDDLFailureReasonsDataModel> getDDL () async{
    ...
    try{
      ...
      if(response.statusCode == 200){
        ...
        debugPrint('Api getDDL 6.1 getDDLFailureReasonsJson ${getDDLFailureReasonsDataList}');
        setState(() {
          getDDLFailureReasonsListLenght = getDDLFailureReasonsDataList.length;
  ...
  SaveDataModel _saveResult;
  String saveStatusCode;
  Future<SaveDataModel> save (String routeCode, String boxNo_value, String stepCode, String inputDDLValue, String inputValue, String compCode) async {
    try {
      final _prefs = await SharedPreferences.getInstance();
      String _API_Path = _prefs.getString('API_Path');
      String _Token = _prefs.getString('Token');
      ...
      debugPrint('Check save routeCode $routeCode ');
      debugPrint('Check save boxNo_value $boxNo_value ');
      debugPrint('Check save stepCode $stepCode ');
      debugPrint('Check save inputValue $inputValue ');
      debugPrint('Check save inputDDLValue $inputDDLValue ');
      debugPrint('Check save compCode $compCode ');
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('Select Failure Reason', style:TextStyle(fontSize: 18,  fontFamily: "Poppins",
          fontWeight: FontWeight.w500,color: appColor)),
      content: Container(
        width: MediaQuery.of(context).size.width,
                            ...
                            child: Column(
                              children: <Widget>[
                                ListTile(
                                  ...
                                  title: Text(getDDLFailureReasonsDataList[index]["FailureReason"], style:TextStyle(fontSize: 16,  fontFamily: "Poppins",
                                      fontWeight: FontWeight.w500,color: appColor),),
                                  trailing: Checkbox(
                                    //title: Text(_resultServices[index].Service,style: TextStyle(fontSize:16, fontFamily: "Camphor",
                                    // fontWeight: FontWeight.w700,color: Colors.black),),
                                    value: getDDLFailureReasonsDataList[index]["IsChecked"],
                                    ...
                                    onChanged: (val) {
                                      setState(() {
                                        ...
                                        for(var i=0;i<getDDLFailureReasonsDataList.length;i++){
                                          if(getDDLFailureReasonsDataList[index] == getDDLFailureReasonsDataList[i]){
                                            getDDLFailureReasonsDataList[i]['IsChecked'] = true;

                                            inputCheckBoxValue = getDDLFailureReasonsDataList[index]["FailureReason"];

                                            print("inputCheckBoxValue : $inputCheckBoxValue");
      ...
      actions: <Widget>[
        ...
        TextButton(
          ...
          onPressed: () async{
            ...
            final SaveDataModel saveresult = await save(widget.routeCode, widget.boxNo_value, widget.stepCode, inputCheckBoxValue, widget.inputValue, widget.compCode);
            debugPrint('2');
            ...
            if (saveresult == null) {
              ...
              if(statusCode == "500"){
                if (_saveResult.ExceptionMessage != "") {
                  ...
                  debugPrint('_displaySnackBarExe **');
                  String exe = _saveResult.ExceptionMessage;
                  Toast.show(exe, context, duration: Toast.LENGTH_SHORT, gravity:  Toast.BOTTOM);
              ...
              if(statusCode == "200"){
                Navigator.pushReplacement(context, SlideLeftRoute(page: DirectScan_BoxRouteDetailsPage(boxNo_Value:widget.boxNo_Value, boxNo:widget.boxNo)));
              }
