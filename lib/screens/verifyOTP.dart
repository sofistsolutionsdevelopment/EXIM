                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        SizedBox(height: 15,),
                                        Text("Enter the OTP sent to", style: TextStyle(fontSize:16,fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,color: Colors.black45,letterSpacing: 0.5),),
                                        SizedBox(height: 5,),
                                        Text("+91 $contactNo", style: TextStyle(fontSize:20,fontFamily: "Poppins",
                                          fontWeight: FontWeight.w500,color: Colors.black,letterSpacing: 0.5),),
                                        SizedBox(height: 25,),
                                        Padding(
                                          ...
                                          child: PinCodeTextField(
                                            ...
                                            pinTheme: PinTheme(
                                                ...
                                                fieldHeight: 50,
                                                fieldWidth: 50,
                                                activeFillColor: appBgColor,inactiveColor: Colors.blueGrey,activeColor: Colors.white,selectedColor: Colors.white, inactiveFillColor: Colors.white, selectedFillColor: Colors.grey
                                            ),
                                            // animationDuration: Duration(milliseconds: 300),
                                            backgroundColor: Colors.white,textStyle: TextStyle(fontFamily: "Poppins",
                                              fontWeight: FontWeight.w500, fontSize: 22, letterSpacing: 2 ),
                          ...
                          child: InkWell(
                            onTap: () async{
                              if (_formStateKey.currentState.validate()) {
                                ...
                                var connectivityResult = await (Connectivity().checkConnectivity());
                                if (connectivityResult == ConnectivityResult.none) {
                                  print("*** _isConnected VerifyOTP btn = $connectivityResult ****");
                                  Navigator.push(context, SlideLeftRoute(page: NoInternetPage()));
                                }
                                else if (connectivityResult == ConnectivityResult.wifi || connectivityResult == ConnectivityResult.mobile) {
                                  print("*** _isConnected VerifyOTP btn = $connectivityResult ****");
                                 ...
                                 // final String otp = "9999";
                                  ...
                                  final VerifyDataModel result = await verifyOTP(otp);
                                  debugPrint('2');
                                  ...
                                  debugPrint('_verifyOTPResult : $_verifyOTPResult');

                                  debugPrint('3');

                                  if(statusCode == "200"){
                                    String Status = "${_verifyOTPResult.Data[index].Status.toString()}";

                                    if(Status == "1"){
                                      SharedPreferences prefs = await SharedPreferences.getInstance();
                                      prefs.setInt('MC_EmpCode', _verifyOTPResult.Data[index].MC_EmpCode);
                                      prefs.setString('Token', _verifyOTPResult.Data[index].Token);
                                      prefs.setString('Username', _verifyOTPResult.Data[index].Username);
                                      prefs.setInt('ReadOnlyUser', _verifyOTPResult.Data[index].ReadOnlyUser);

                                      debugPrint('Check 2.1 MC_EmpCode  : ${_verifyOTPResult.Data[index].MC_EmpCode}');
                                      debugPrint('Check 2.1 Token : ${_verifyOTPResult.Data[index].Token}');
                                      debugPrint('Check 2.1 Username : ${_verifyOTPResult.Data[index].Username}');
                                      debugPrint('Check 2.1 ReadOnlyUser : ${_verifyOTPResult.Data[index].ReadOnlyUser}');
                                      debugPrint('4.1');
                                    ...
                                    if(Status == "0"){
                                      ...
                                      String exe = _verifyOTPResult.Data[index].Message;
                                      setState(() {
                                        _isInAsyncCall = false;
                                      });
