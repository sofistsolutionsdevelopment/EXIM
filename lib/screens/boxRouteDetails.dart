...
class BoxRouteDetailsPage extends StatefulWidget {
  ...
  BoxRouteDetailsPage({this.onPressed, this.exportType_value, this.exportType, this.boxNo_Value, this.boxNo, this.invoiceNo, this.custShortCode, this.boxCount});
...
class _BoxRouteDetailsPageState extends State<BoxRouteDetailsPage> {
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('Are you sure to confirm this step?', style: TextStyle(fontFamily: "Poppins",
  ...
  showConfirmationDialog(BuildContext context, String routeCode, String boxNo_value, String stepCode, String inputValue, String compCode) {
    showDialog(
      ...
      context: context,
      builder: (BuildContext context) {
        return CustomDialog(routeCode:routeCode, boxNo_value:boxNo_value, stepCode:stepCode, inputValue:inputValue, compCode:compCode, exportType_value:widget.exportType_value, exportType:widget.exportType, boxNo_Value:widget.boxNo_Value, boxNo:widget.boxNo, boxCount:widget.boxCount);
      },
    );
  }
}
