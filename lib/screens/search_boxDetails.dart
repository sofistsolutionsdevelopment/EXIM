...
class _Search_BoxDetailsPageState extends State<Search_BoxDetailsPage> {
  ...
  Future<GetBoxDetailsDataModel> getBoxDetails(String _search) async {
    ...
    try {
      ...
      final String apiUrl = "$APIPath/Dashboard/GetBoxDetailsForSearch";

      print("Api getBoxDetails 2");
      print("Api getBoxDetails _Token : $Token");
      final response = await http.post(
        ...
        body: json.encode({"SearchValue": _search}),
      );

      print("Api getBoxDetails 3");

      print(
          "Api getBoxDetails response code : ${response.statusCode} and error is ${response.body}");
